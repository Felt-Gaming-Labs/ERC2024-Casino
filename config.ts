...
export const PLATFORM_CREATOR_ADDRESS = new PublicKey(
  "8kYDDsqm3y2JTQj2CAsRGmwpeMp8FohMxifWf1L89nkC",
);
...
// Jackpot fee (in %)
export const PLATFORM_JACKPOT_FEE = 0.00; // 1% (1/100 = 0.01)

// Platform URL - Appears in ShareModal
export const PLATFORM_SHARABLE_URL = "casino.erection2024.club";
...
export const PLATFORM_EXPLORER_URL = `https:/casino.erection2024.club${PLATFORM_CREATOR_ADDRESS.toString()}`;
